...
export default function Login() {
  ...
  return (
    ...
    <div className="mx-auto w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl bg-white shadow-input dark:bg-black rounded-3xl p-4 sm:p-6 md:p-8">
      ...
      {error && (
        <p className="mt-4 sm:mt-8 text-center text-sm text-red-500 dark:text-red-400">
          {error}
        </p>
      )}
